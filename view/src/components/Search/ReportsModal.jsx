...
const ReportsModal = (props) => {
  ...
  return (
    ...
    >
      {props.reportMessage && <h3 className="modal__title">Are you sure you want to {props.reportMessage} this user?</h3>}
      <button className="reportsModalButton" onClick={reportBlock}>
        Confirm
  </button>
      <button className="reportsModalButton" onClick={props.closeConfirmationReport}>
        Cancel
</button>
    </Modal>
  )
